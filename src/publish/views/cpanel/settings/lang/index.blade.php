...
<div class="actions">
@if (has_perm('Settings\LangController@create'))
  {{-- start has perm. create lang --}}
...
@foreach (\App\Lang::all() as $lang)
	...
	<div class="col-md-4">
	<div class="form-group">
	@if (has_perm('Settings\LangController@updateFlug'))
  {{-- start has perm. update flug --}}
...
@endforeach
	...
	{{-- end has perm. update flug --}}
@endif
@if (has_perm('Settings\LangController@updateFiles'))
  {{-- start has perm. translate file --}}
...
<input type="hidden" name="lang" value="{{ $lang->id }}">
	...
	{!! Form::close() !!}
		...
		{{-- end has perm. translate file --}}
@endif 
@if (has_perm('Settings\LangController@update'))
  {{-- start has perm. edit lang --}}
...
<div class="modal fade" id="modal-edit-{{ $lang->id }}">
	<div class="modal-dialog">
		...
		{{-- end has perm. edit lang --}}
@endif 
@if (has_perm('Settings\LangController@deleteLang'))
  {{-- start has perm. delete lang --}}
